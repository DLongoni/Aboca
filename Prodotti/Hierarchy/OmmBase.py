...
if 1:
    ...
    for n_clusters in clust_range:
        ...
        linkage_m3 = linkage(CA.get_df(df_name='scaled', cols=tuple(features3)), 'ward')
        ...
        Kpreds3 = Kclusterer.fit_predict(CA.get_df(df_name='scaled', cols=tuple(features3)))
